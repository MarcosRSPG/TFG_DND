...
def _to_schema(doc: dict) -> dict:
    ...
    try:
        return AdventuringGearSchema(**payload).model_dump(exclude_none=True)
...
async def get_by_id(adventuringgear_id: str) -> dict:
...
async def create(adventuringgear_schema: AdventuringGearSchema, created_by: str | None) -> dict:
...
async def update(adventuringgear_id: str, adventuringgear: AdventuringGearSchema) -> dict:
...
async def get_all_adventuringgears() -> list[dict]:
    return await get_all()

async def get_adventuringgear_by_id(adventuringgear_id: str) -> dict:
    return await get_by_id(adventuringgear_id)

async def create_adventuringgear(adventuringgear_schema: AdventuringGearSchema, created_by: str | None) -> dict:
    return await create(adventuringgear_schema, created_by)

async def update_adventuringgear(adventuringgear_id: str, adventuringgear: AdventuringGearSchema) -> dict:
